...
return {
	remove_paintings      = {name = "remove-paintings",      only_for_admin = true, is_allowed_empty_args = true, description = {"brush-tools-commands.description.remove-paintings"}},
	remove_all_paintings  = {name = "remove-all-paintings",  only_for_admin = true, is_allowed_empty_args = true, description = {"brush-tools-commands.description.remove-all-paintings"}, allow_for_server = true},
	count_paintings       = {
							 name = "count-paintings", is_allowed_empty_args = true, description = {"brush-tools-commands.count-paintings"},
							 player_cooldown = 60, disable_cooldown_for_admins = true, disable_cooldown_for_server = true
							},
	count_all_paintings   = {name = "count-all-paintings",   is_allowed_empty_args = true, description = {"brush-tools-commands.count-all-paintings"}, allow_for_server = true},
	delete_brush_tools_UI = {name = "delete-brush-tools-UI", only_for_admin = true, is_allowed_empty_args = true, description = {"brush-tools-commands.delete_UI"}, allow_for_server = true},
}
